...
class Restaurante:
    ...
    def __str__(self):
        return f"O nome do restaurante é {self.nome} | a categoria é {self.categoria}"
    ...
    def exibir_no_cardapio(self):   
        ...
        for i,item in enumerate(self._cardapio, 1):
            if hasattr(item, "descricao"):
                ...
                mensagem_da_bebida = f"{i}. Nome:{item._nome} | Preço: R${item._preco} | Tamanho: {item.tamanho}"
                print(mensagem_da_bebida)
